...
class ScrapeSuffolk extends Job implements SelfHandling, ShouldQueue
{
    ...
    public function handle()
    {
        ...
        echo $time . ' Beginning Scrape for ' . $this->pollster->name . ' via Suffolk page' . "\n";
        // Make a new bot and call the scrape
        $bot = new ScraperBot();
        $bot->scrapeSuffolk($this->pollster);
    }
}
