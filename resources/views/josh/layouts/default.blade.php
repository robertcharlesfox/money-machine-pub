    ...
    <header>
        ...
        <nav class="navbar navbar-default container">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="/autotrade/dashboard"><img src="{{ asset('assets/images/logo.png') }}" alt="logo" class="logo_position">
                </a>
            </div>
            <div class="collapse navbar-collapse" id="collapse">
                <ul class="nav navbar-nav navbar-right">
                    <li {!! (Request::is('/') ? 'class="active"' : '') !!}><a href="/autotrade/dashboard"> Home</a>
                    </li>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="control-bar sandbox-control-bar mt10">
                    <a href="/autotrade/states/dem" class="btn btn-success">States - Dem</a>
                    <a href="/autotrade/states/gop" class="btn btn-success">States - GOP</a>
                    <a href="/autotrade/debates" class="btn btn-success">Debates</a>
                    <a href="/autotrade/obama" class="btn btn-success">Obama Approval</a>
                    <a href="/autotrade/binary" class="btn btn-success">Binary Events</a>
                    <a href="/autotrade/check_trades" class="btn btn-warning">Check Executed Trades</a>
                    <a href="/pi/analyze/lines" class="btn btn-primary">Line Analysis</a>
                </div>
            </div>
        </div>
    </div>
