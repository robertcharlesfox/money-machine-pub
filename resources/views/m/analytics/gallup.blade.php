@extends('m.base')
@section('content')
  <h3>Gallup Daily Analytics </h3>
  <div class="row">
    <h5>
      <div class="col-md-1">END DATE</div>
      <div class="col-md-2">Result/Calc</div>
      <div class="col-md-2">Daily Confirmed</div>
  ...
  @for ($i=0 ; $i < 25 ; $i++)
    @if ($dailies[$i]->gallup_daily_confirmed > 0)
    <div class="panel panel-success">
    @elseif ($dailies[$i]->gallup_daily_estimate > 0)
    ...
    @endif
      <div class="panel-heading" role="tab">
        <h4 class="panel-title">
          <div class="row">
            <form id="daily-{{ $dailies[$i]->id }}" action="/analyze/gallup" method="post">
              ...
              <div class="col-md-2">
                <input type="text" name="gallup_daily_confirmed" value="{{ $dailies[$i]->gallup_daily_confirmed }}" class="form-control" />
              </div>
              <div class="col-md-2">
                <input type="text" name="gallup_daily_estimate" value="{{ $dailies[$i]->gallup_daily_estimate }}" class="form-control" />
              </div>
              <div class="col-md-1">
